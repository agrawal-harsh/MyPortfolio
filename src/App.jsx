...
function App() {
   return (
    ...
    <img class = "p-2 lg:invisible sm:visible" src = {myImage}/>
    </div>
  <div class = "flex flex-col items-center text-slate-800 lg:mt-28 lg:flex-row-reverse lg:justify-around lg:mx-36 lg:gap-8">
    <img class = "w-44 h-44 sm:mt-5 object-cover rounded-full lg:h-60 lg:w-60" src = "My image.jpg"/>
    ...
    <button class = "text-white bg-red-500 px-5 py-2 font-semibold text-lg rounded mt-7 lg:text-xl" onClick = "window.location.href = 'https://drive.google.com/file/d/1tiuxVI74HbnGtZ4KJ_7tsWnInWNp8_fk/view?usp=drive_link'">Download Resume</button>
    </div>
  </div>
  ...
  <div class = "h-48 flex flex-col justify-center items-center">
    <div class = "flex h-8 mx-16 gap-9">
